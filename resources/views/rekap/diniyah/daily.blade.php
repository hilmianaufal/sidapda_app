...
@section('title', 'Rekap Diniyah')
@section('mobile_title', 'Diniyah')

@section('content')

<x-ui.page-header
    title="Rekap Diniyah"
    subtitle="Rekap seluruh kegiatan diniyah"
    icon="bi-book"
/>
...
<div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    ...
    <x-ui.button
        :href="route('rekap-diniyah.export.excel', ['period' => 'daily'] + request()->query())"
        variant="secondary"
