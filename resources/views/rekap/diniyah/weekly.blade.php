...
@section('title', 'Rekap Diniyah Mingguan')
@section('mobile_title', 'Diniyah Mingguan')

@section('content')

<x-ui.page-header
    title="Rekap Diniyah Mingguan"
...
<div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    ...
    <x-ui.button
        :href="route('rekap-diniyah.export.excel', ['period' => 'weekly'] + request()->query())"
        variant="secondary"
