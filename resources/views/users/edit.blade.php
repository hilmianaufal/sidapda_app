...
@section('mobile_title','Edit User')
      ...
      <x-ui.card>
        <div class="mb-6">
          ...
          <div class="mt-1 text-sm font-medium text-slate-500">
            Perbarui data identitas dan akses user.
          </div>
        </div>
        ...
        <div class="grid gap-5 md:grid-cols-2">
          ...
          <div class="md:col-span-2">
            <x-ui.form-group label="Reset Password">
              <x-ui.input
                type="password"
                name="password"
          ...
          <div class="md:col-span-2">
            <x-ui.form-group label="Catatan">
              <textarea
                ...
                placeholder="Keterangan user...">{{ old('notes', $user->notes) }}</textarea>
            </x-ui.form-group>
          </div>
